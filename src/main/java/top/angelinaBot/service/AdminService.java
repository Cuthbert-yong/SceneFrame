...
public class AdminService {
    ...
    @AngelinaGroup(keyWords = {"关闭"}, description = "关闭稀音的某个功能")
    public ReplayInfo closeFunc(MessageInfo messageInfo) {
        ReplayInfo replayInfo = new ReplayInfo(messageInfo);
        if (messageInfo.getUserAdmin().equals(MemberPermission.MEMBER) && !messageInfo.getQq().equals(1790967910L)) {
    ...
    @AngelinaGroup(keyWords = {"开启", "打开"}, description = "打开稀音的某个功能")
    ...
    @AngelinaGroup(keyWords = {"已关闭", "功能开关"}, description = "查看稀音当前已关闭的功能")
